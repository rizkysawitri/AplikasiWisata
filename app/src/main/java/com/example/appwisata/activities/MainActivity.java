...
import com.example.appwisata.adapter.MainAdapter;
import com.example.appwisata.decoration.LayoutMarginDecoration;
import com.example.appwisata.model.ModelMain;
...
public class MainActivity extends AppCompatActivity implements MainAdapter.onSelectData {
    ...
    private void setMenu() {
        mdlMainMenu = new ModelMain("Wisata", R.drawable.ic_destination1);
        lsMainMenu.add(mdlMainMenu);
        mdlMainMenu = new ModelMain("About", R.drawable.ic_about);
        lsMainMenu.add(mdlMainMenu);
    ...
    public void onSelected(ModelMain mdlMain) {
        switch (mdlMain.getTxtName()) {
            case "Wisata":
                ...
                break;
            case "About":
                startActivityForResult(new Intent(MainActivity.this, AboutAppActivity.class), 1);
                break;
        }
    }
